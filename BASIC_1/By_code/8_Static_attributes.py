...
# These are commonly referred to as class variables. These are attributes that
#  belong to the class itself and are shared among all instances of the class.
...
print(user1.user_count)  # Output: 2 (but it's still shared, as this accesses User.user_count)
